...
class APICallStats:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "avg_response_time": self.total_response_time / self.total_calls if self.total_calls > 0 else 0
        }
...
class APIMonitor:
        ...
        with self.lock:
            ...
            if is_rate_limit:
                ...
                self.rate_limit_history = [
                    t for t in self.rate_limit_history if t > one_hour_ago
                ]
    ...
    def get_rate_limit_stats(self, window_minutes: int = 60) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            recent_hits = [
                t for t in self.rate_limit_history if t > window_start
            ]

            return {
                "window_minutes": window_minutes,
                "rate_limit_hits": len(recent_hits),
                "hits_per_hour": len(recent_hits) * (60 / window_minutes) if window_minutes > 0 else 0,
    ...
    def __init__(self):
        ...
        if not hasattr(self, '_initialized'):
            ...
            self.alert_manager = APIAlertManager(
                threshold_per_hour=20,  # 每小时20次告警阈值
