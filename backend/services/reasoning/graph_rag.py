...
class EntityExtractor:
    ...
    PATTERNS = {
        "功法": r"(捧气贯顶法|形神庄|五元庄|三心并站庄|中脉混元功|中线混元功|混化归元功"
        r"|八段锦|五禽戏|六字诀|易筋经|太极拳|形意拳|八卦掌|练气八法)",
        "穴位": r"(百会|膻中|气海|关元|命门|涌泉|足三里|合谷|太冲|内关|神阙"
        r"|中脘|天枢|大椎|风池|太溪|三阴交|血海|曲池|肩井|肾俞|肝俞"
        r"|脾俞|肺俞|心俞|印堂|太阳|劳宫)",
        "概念": r"(混元气|意元体|阴阳|五行|气血|丹田|调身|调息|调心|运用意识"
        r"|内求法|三传并用|仁|义|礼|智|信|孝|道|无为|禅|定|慧|觉悟"
        r"|天人合一|精气神|中庸)",
        "动作": r"(站桩|打坐|吐纳|导引|行气|采气|发气|拉气|组场|收功)",
        "脏腑": r"(心|肝|脾|肺|肾|胃|胆|膀胱|三焦|心包|小肠|大肠)",
        "人物": r"(庞明|庞鹤鸣|冯广德|樊志诚|黄帝|岐伯|张仲景|华佗|孙思邈"
        r"|李时珍|孔子|孟子|荀子|朱熹|王阳明|老子|庄子|列子"
        r"|释迦牟尼|达摩|慧能|玄奘|张三丰)",
        "典籍": r"(黄帝内经|伤寒论|金匮要略|本草纲目|难经|温病条辨|神农本草经"
        r"|千金方|论语|孟子|大学|中庸|道德经|庄子|周易|心经|金刚经"
        r"|坛经|智能气功科学概论|智能气功科学精义|智能气功科学混元整体理论"
        r"|智能气功科学功法学|智能气功科学超常智能)",
        "经络": r"(手太阴肺经|手阳明大肠经|足阳明胃经|足太阴脾经|手少阴心经"
        r"|手太阳小肠经|足太阳膀胱经|足少阴肾经|手厥阴心包经|手少阳三焦经"
        r"|足少阳胆经|足厥阴肝经|任脉|督脉|冲脉|带脉)",
        "病症": r"(头痛|眩晕|失眠|心悸|咳嗽|哮喘|胃痛|腹痛|便秘|腹泻|水肿|痹症|中风|消渴)",
        "药材": r"(人参|黄芪|当归|白术|茯苓|甘草|川芎|白芍|熟地黄|桂枝|麻黄"
        r"|柴胡|黄芩|半夏|陈皮|丹参)",
        "方剂": r"(四君子汤|四物汤|八珍汤|六味地黄丸|逍遥散|桂枝汤|麻黄汤"
        r"|小柴胡汤|大柴胡汤|补中益气汤|归脾汤)",
        "理论": r"(混元整体理论|阴阳五行学说|藏象学说|经络学说|气血津液学说"
        r"|病因学说|辨证论治|天人相应|形神合一|理法方药)",
        "组织": r"(石家庄智能气功进修学院|华夏智能气功培训中心|智能气功研究会"
        r"|中国中医药研究院|北京中医药大学)",
    }
