...
class SecurityScoreCalculator:
    ...
    def parse_npm_audit_report(self, report_path: str):
        ...
        try:
            ...
            self.frontend_critical_high = (
                vuln_metadata.get('critical', 0) +
                vuln_metadata.get('high', 0)
            )
        ...
        return {
            ...
            "backend": {
                ...
                "bandit": {
                    ...
                    "score": 40 if self.backend_bandit_high == 0 else (30 if self.backend_bandit_high == 1 else 0),
                },
                "safety": {
                    "vulnerabilities": self.backend_safety_vulns,
                    "high_severity": self.backend_safety_high_severity,
                    "score": 20 if self.backend_safety_high_severity == 0 else (15 if self.backend_safety_high_severity == 1 else 5),
                },
            },
            "frontend": {
                ...
                "npm_audit": {
                    ...
                    "score": 40 if self.frontend_critical_high == 0 else (20 if self.frontend_critical_high == 1 else 0),
                },
            },
